    ...
    def traj_evaluate(self):
        ...
        for attr_vals in res:
            ...
            for attr_name in ids_attrs:
                try: self.res[attr_name].append(attr_vals[attr_name])
                except: self.res[attr_name] = [attr_vals[attr_name]]
    ...
    def time_evaluate2(self, step=1):
        ...
        for fcn in functions:
            ...
            if "overlap" in attr_name:
                ...
                #print("Overlaps: {},{}".format(overlaps, len(overlaps)))
            else:
